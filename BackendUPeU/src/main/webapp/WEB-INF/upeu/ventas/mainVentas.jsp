        ...
        <td>
          ...
          <div class="panel panel-default">
              ...
              <div class="tablecontainer">
                ...
                <c:forEach items="${ListaVentas}" var= "dato">   
                <tr>
                    <td><c:out value="${dato.idCliente.idPersona.nombres}"/></td>
                    <td><c:out value="${dato.codigo}"/></td>
                    <td><c:out value="${dato.estado}"/></td>
                    
                    <td>
                        <a href="eliminarVentas?id=${dato.idVenta}">Eliminar</a>&emsp14;  
                        <a href="modificarVentasX?id=${dato.idVenta}">Modificar</a>
                    </td>
                </tr>
                </c:forEach>
                            </table>
